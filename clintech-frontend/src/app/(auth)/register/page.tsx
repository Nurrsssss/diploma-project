        ...
        <div className="grid h-screen w-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-slate-100 md:grid-cols-5">
            ...
            >
                <div className='row-span-1 absolute top-[7%] left-[7%]'>
                    <h1 className='font-outfit text-7xl font-bold text-cyan-100 lg:text-8xl xl:text-[143px]'>ClintechAI</h1>
            ...
            <div className='flex flex-col bg-surface p-4 md:col-span-2 md:rounded-l-3xl lg:p-8 2xl:p-10'>
                <RegisterForm/>
            </div>
        </div>
    )
