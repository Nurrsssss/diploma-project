...
Logger Service предоставляет единый интерфейс для сбора, хранения и анализа логов со всех микросервисов платформы Clintech. Сервис интегрируется с Elasticsearch для хранения логов и Kibana для их визуализации.
...
3. Создайте индекс-паттерн "clintech-logs-*"
