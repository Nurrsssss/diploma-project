...
func main() {
	...
	// Снимаем уникальность с email, если такой индекс уже существует
	db.Exec("DROP INDEX IF EXISTS idx_doctors_email")
	db.Exec("DROP INDEX IF EXISTS doctors_email_key")
