    ...
    "paths": {
        ...
        "/appointments/{appointmentID}/files": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Список файлов записи",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "files": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Тип файла (анализы, рецепт и т.д.)",
                        "name": "file_type",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Описательное название файла",
                        "name": "name",
                        "in": "formData"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Неверный файл или параметры",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "error": {
        ...
        "/appointments/{appointmentID}/files/{fileID}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Файл или запись не найдены",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "error": {
        ...
        "/appointments/{appointmentID}/files/{fileID}/download": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/users/avatar": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Файл аватарки (JPEG/PNG, макс 3MB)",
                        "name": "avatar",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Неверный файл или превышен размер",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "error": {
