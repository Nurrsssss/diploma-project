# Интеграция FileServerService с Clintech

## Обзор

FileServerService был успешно интегрирован в экосистему Clintech и теперь является частью общей микросервисной архитектуры.
...
fileserver_service:
  ...
  container_name: clintech_fileserver
  environment:
    - SERVER_PORT=8803
    - DB_HOST=postgres
    - DB_NAME=clintech_db
...
- **Elasticsearch**: Логи отправляются в общий индекс `clintech-logs`
